 ...
 * @author Saul Neri
 */
public class MesaDTO_1 implements Serializable {
     ...
     */
    public MesaDTO_1(Long id, String codigo, TipoMesaDTO tipoMesa, UbicacionMesaDTO ubicacion, RestauranteDTO restaurante) {
        this.id = id;
        this.codigo = codigo;
     ...
     * @param ubicacion La ubicación de la mesa en el restaurante.
     */
    public MesaDTO_1(String codigo, TipoMesaDTO tipoMesa, UbicacionMesaDTO ubicacion) {
        this.codigo = codigo;
        this.tipoMesa = tipoMesa;
        this.ubicacion = ubicacion;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof MesaDTO_1)) {
            return false;
        }
        MesaDTO_1 other = (MesaDTO_1) object;
