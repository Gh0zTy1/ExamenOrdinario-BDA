...
public class RestauranteDTO_1 {
     ...
     */
    public RestauranteDTO_1(Long id) {
        this.id = id;
    }
     ...
     */
    public RestauranteDTO_1(Long id, String nombre, String telefono, String direccion, LocalTime horaApertura, LocalTime horaCierre) {
        this.id = id;
        this.nombre = nombre;
