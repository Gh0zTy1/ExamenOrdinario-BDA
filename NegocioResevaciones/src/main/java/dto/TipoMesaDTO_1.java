 ...
 * @author Saul Neri
 */
public class TipoMesaDTO_1 implements Serializable {
     ...
     */
    public TipoMesaDTO_1(Long id, String nombre, Integer maximoPersonas, Integer minimoPersonas, Float precio) {
        this.id = id;
        this.nombre = nombre;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TipoMesaDTO_1)) {
            return false;
        }
        TipoMesaDTO_1 other = (TipoMesaDTO_1) object;
