 ...
 * @author Saul Neri
 */
public class ReservacionDTO_1 implements Serializable {
     ...
     */
    public ReservacionDTO_1(Long id) {
        this.id = id;
        this.estado = EstadoReservacionDTO.PENDIENTE; 
    }
     ...
     */
    public ReservacionDTO_1(Long id, LocalDateTime fechaHora, Integer numeroPersonas, EstadoReservacionDTO estado, MesaDTO mesa, ClienteDTO cliente, Float montoTotal, MultaDTO multa) {
        this.id = id;
     ...
     * @param multa La multa asociada a la reservación.
     */
    public ReservacionDTO_1(LocalDateTime fechaHora, Integer numeroPersonas, EstadoReservacionDTO estado, MesaDTO mesa, ClienteDTO cliente, Float montoTotal, MultaDTO multa) {
        this.fechaHora = fechaHora;
        this.numeroPersonas = numeroPersonas;
        this.estado = estado;
        this.mesa = mesa;
